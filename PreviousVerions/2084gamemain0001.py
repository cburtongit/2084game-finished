...
running = True
while running:
    pygame.time.delay(100) # this is a way to create a "clock" in pygame apparently, I can probably use this to set the speed of animations or actions later
    ...
    if kbinput[pygame.K_LEFT]:
        x -= vel
    if kbinput[pygame.K_RIGHT]:
        x += vel
    if kbinput[pygame.K_UP]:
        y -= vel
    if kbinput[pygame.K_DOWN]:
        y += vel
